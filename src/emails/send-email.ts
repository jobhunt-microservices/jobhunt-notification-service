...
class SendMailTemplates {
  sendEmail = async (template: string, receiver: string, locals: IEmailLocals): Promise<void> => {
    try {
...
export const sendMailTemplates = new SendMailTemplates();
